...
<div style="display: flex; align-items: center;">
  ...
  <div style="flex: 1; text-align: center; padding: 10px;">
    <img src="./assets/me.jpg" alt="My Photo" style="width: 80%; border-radius: 50%; box-shadow: 0 4px 8px rgba(0,0,0,0.1);" />
  </div>
  ...
  <div style="flex: 2; padding: 10px;">
    ...
    <p>Feel free to explore my <a href="link-to-CV.pdf" target="_blank">CV</a> or browse my <a href="link-to-research">research highlights</a>.</p>
  </div>
...
![](https://niklas-mueller.github.io/me.jpg)
