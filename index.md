...
<div class="left-column">
  ...
  <p style="font-size:0.8rem;color:#666;margin-top:6px;">Photo credit to Benjamin Vanderveen</p>
</div>
...
<div class="middle-column">
    ...
    <p>Feel free to explore my <a href="/assets/files/Scientific_CV_NiklasMueller-EN.pdf" target="_blank">CV</a> or browse my <a href="publications">publications</a> and other <a href="news">news</a>.</p>

</div>

<!-- Right: Blog post headers -->
<div class="right-column">
  <div style="font-weight:bold">Recent Posts</div>
  <ul>
    {%- assign posts = site.publications | sort: 'date' | reverse %}
    {% for post in posts reversed limit:3 %}
      <li>{%- if post.preprint and post.preprint == true -%}Preprint:&nbsp;{%- endif -%}<a href="{{ post.doi_url | relative_url }}">{{ post.title }}</a></li>
    {% endfor %}
